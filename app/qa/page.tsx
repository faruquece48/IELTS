...
const qaList = [
  ...
  { question: "How do the expensive items that younger people want to buy differ from those older people want to buy?", answer: "The preferences between the generations regarding luxury items and expensive products have differed a lot in the last decade. On one hand, young people prefer to spend their money on products that they can sell off, like fancy watches, cars, clothes, bags, and shoes. On the other hand, older generations invest their money in big houses or buy a second home. They prefer to spend their money on future-oriented activities rather than buying products just to promote their status." },
